...
import com.mycompany.nocapgameslauncher.gui.styling.*;
...
public class HeaderCreator {
    ...
    public static JPanel createHeader(mainFrame frame, JPanel sidebarPanel) {
        ...
        themeToggle.setFont(new Font("Arial", Font.PLAIN, 24));
        themeToggle.setForeground(Color.WHITE);
        themeToggle.setBackground(new Color(0x202020));
        themeToggle.setBorderPainted(false);
        themeToggle.setFocusPainted(false);
        themeToggle.setContentAreaFilled(false);
        themeToggle.addActionListener(_ -> {
            styles.changeTheme();
            System.out.println("Theme clicked!");
        });
